...
import { getServices } from "../../../services/api"; // Assuming api.js is in the same directory

// Inline SVG icons - you might want to move these to a separate file for clarity
// For the sake of this example, we'll keep them here.
const serviceIcons = {
  "Engine Repair": (
    <svg
...
const ServicesSection = () => {
  ...
  const styles = {
    // Your inline styles remain the same
    servicesSection: {
            ...
            >
              <div style={styles.iconWrapper}>
                {serviceIcons[service.service_name] ||
                  serviceIcons["Engine Repair"]}
              </div>
              <h3 style={styles.cardTitle}>{service.service_name}</h3>
